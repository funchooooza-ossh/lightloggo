"""
Internal C-level wrapper for the Text Formatter resource.

This module provides the CTextFormatter class, which directly interfaces
with the FFI layer to create and manage a text formatter instance within
the Go core library.
"""
...
class CTextFormatter:
    """
    A low-level handle to a text formatter resource in the Go core.
    ...
    def __init__(self, style_id: int = 0, max_depth: int = 3) -> None:
        """
        Initializes the CTextFormatter by creating a new resource via FFI.
        ...
        """
        # Call the FFI function to create a new text formatter instance
